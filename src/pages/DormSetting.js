    ...
    <div className="dormsetting">
      ...
      <div class="container pb-3">
        ...
        <form method="POST" action="">
          <div class="container bg-danger col-10 mb-3 pt-2 pb-3">
            <div class="row">
          ...
          <div class="container col-10 bg-danger mb-3 pt-2 pb-3">
            <div class="row">
          ...
          <div class="container col-10 bg-danger pt-2 pb-3 mb-2 ">
